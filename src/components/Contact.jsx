                    ...
                    <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:aviksehgal0333@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                        aviksehgal0333@gmail.com
                                    </a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+919896451998" className="text-muted-foreground hover:text-primary transition-colors">
                                        +919896451998
                                    </a>
                                </div>
                            </div>
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                    ...
                    <form className="space-y-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="Avik Sehgal..."/>
                        </div>
                        <div>
